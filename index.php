<?php
    ...
    if(isset($_SESSION['nipAdmin']) AND isset($_SESSION['roleAdmin']) == 'pembina'){
        header("Location: pembina/home.php");
        exit;
    }
    
    if(isset($_SESSION['nisnSiswa']) AND isset($_SESSION['roleSiswa']) == 'senior'){
        ...
        <form method="POST">
            ...
            <table >
                <tr>
                    ...
                    <td><input type="text" name="nisnnip" id="nisnnip"></td>
                </tr>
                <tr>

...
<?php
        ...
        $notifInput = $idEnter = $nisnSenior = $nilaiKeaktifan  = $nilaiPolaPikir = $nilaiSikap = $pelanggaran = '';
        if(isset($_POST['simpan'])){
            $idEnter = $_POST['idEntered'];
            $nisnSenior = $_POST['nisn'];
            ...
            if (!empty($idEnter) && !empty($nisnSenior) && !empty($nilaiSikap) && !empty($nilaiPolaPikir) && !empty($nilaiKeaktifan) && isset($pelanggaran)) {
                ...
                if($input1 && $input2 && $input3){
                    ...
                    if($inputEntered){
                        ...
                        if($queryInputNewId){
                            header("Location: ./nilai_senior.php");
                            exit;
                        }
                    }
                }
...
<h1>Input Nilai Senior</h1>
<p><?=$notifInput?></p>
<form method="POST">
<div class="container">
    <div class="isiform">
      <div class="data">
        <label class="isitext" for="">ID</label>
